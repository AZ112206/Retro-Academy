...
export default function RetroIcon({ kind, size = 28 }) {
  ...
  const icons = {
    ...
    pencil: [
      <span key="body" style={{ ...pixel(amber, '5px', '15px', '16px', '4px'), transform: 'rotate(-25deg)', transformOrigin: 'left center' }} />,
      <span key="eraser" style={{ ...pixel(red, '3px', '14px', '4px', '4px'), transform: 'rotate(-25deg)', transformOrigin: 'left center' }} />,
      <span key="tip" style={{ ...pixel(paper, '19px', '11px', '5px', '4px'), clipPath: 'polygon(0 0, 100% 50%, 0 100%)', transform: 'rotate(-25deg)', transformOrigin: 'left center' }} />,
    ],
    book: [
      <span key="left" style={pixel(paper, '5px', '7px', '8px', '16px')} />,
      <span key="right" style={pixel(neon, '15px', '7px', '8px', '16px')} />,
      <span key="spine" style={pixel(dark, '13px', '7px', '2px', '16px')} />,
    ],
    math: [
      <span key="frame" style={pixel(paper, '6px', '6px', '16px', '16px')} />,
      <span key="line1" style={pixel(dark, '13px', '8px', '2px', '12px')} />,
      <span key="line2" style={pixel(dark, '8px', '13px', '12px', '2px')} />,
    ],
    science: [
      <span key="neck" style={pixel(paper, '12px', '5px', '4px', '6px')} />,
      <span key="flask" style={{ ...pixel(cyan, '8px', '10px', '12px', '12px'), clipPath: 'polygon(25% 0, 75% 0, 100% 100%, 0 100%)' }} />,
      <span key="bubble" style={pixel(neon, '18px', '7px', '4px', '4px')} />,
    ],
    history: [
      <span key="col1" style={pixel(paper, '7px', '9px', '3px', '12px')} />,
      <span key="col2" style={pixel(paper, '13px', '9px', '3px', '12px')} />,
      <span key="col3" style={pixel(paper, '19px', '9px', '3px', '12px')} />,
      <span key="roof" style={pixel(neon, '5px', '6px', '18px', '3px')} />,
      <span key="base" style={pixel(neon, '5px', '21px', '18px', '3px')} />,
    ],
    language: [
      <span key="bubble1" style={{ ...pixel(paper, '5px', '8px', '10px', '8px'), borderRadius: '4px' }} />,
      <span key="tail1" style={{ ...pixel(paper, '8px', '15px', '4px', '4px'), clipPath: 'polygon(0 0, 100% 0, 0 100%)' }} />,
      <span key="bubble2" style={{ ...pixel(neon, '13px', '12px', '10px', '8px'), borderRadius: '4px' }} />,
      <span key="tail2" style={{ ...pixel(neon, '17px', '19px', '4px', '4px'), clipPath: 'polygon(100% 0, 100% 100%, 0 0)' }} />,
    ],
    globe: [
      <span key="circle" style={{ ...pixel(cyan, '6px', '6px', '16px', '16px'), borderRadius: '50%' }} />,
      <span key="v" style={pixel(neon, '13px', '6px', '2px', '16px')} />,
      <span key="h" style={pixel(neon, '6px', '13px', '16px', '2px')} />,
    ],
    controller: [
